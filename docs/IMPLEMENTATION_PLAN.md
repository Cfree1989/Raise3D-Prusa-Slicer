...
5. Print: XL-style 0.4 mm family (0.10 FAST DETAIL, 0.15/0.20/0.25 SPEED and STRUCTURAL, 0.28 DRAFT). Default 0.20 mm SPEED. Motion clipped to Pro2 Hyper FFF L1 (150 mm/s, 5000 mm/s², 15 mm³/s). Travel 150 mm/s. Accel: print 2000 (ideaMaker) / travel 5000 (ideaMaker) / first layer 500 (XL). First layer 40 mm/s walls and infill on every profile. `ensure_m99123_first.py` converts `M204 S` to `SET_VELOCITY_LIMIT`. Wipe tower on — default X50 Y140 (past T1 keep-out); relative E / `M83` (ideaMaker used `M82`).
...
- ideaMaker first layer 0.30 mm, skirt, and 15 mm/s first-layer feed (print family stays XL: 0.20 mm, no skirt, 40 mm/s first-layer walls and infill, 500 mm/s² first-layer accel)
