...
class VendorStructureTests(unittest.TestCase):
    ...
    def test_vendor_and_model_sections(self) -> None:
        ...
        self.assertEqual(self.ini["vendor"]["config_version"], "0.5.24")
    ...
    def test_print_is_xl_layout_capped_at_hyper_fff_l1(self) -> None:
        ...
        self.assertEqual(p["first_layer_acceleration"], "5000")
    ...
    def test_xl_style_print_family_exists(self) -> None:
        ...
        self.assertNotIn("perimeter_acceleration", structural)
        self.assertNotIn("default_acceleration", structural)
